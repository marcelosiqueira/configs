<div class="grid_16" id="content">
    <!--  TITLE START  --> 
    <div class="grid_9">
    	<h1 class="dashboard">Notícias</h1>
    </div>
    <div class="clear"></div>
    <!--  TITLE END  -->    
    <!-- #PORTLETS START -->
        ...
        <form action="" method="post">
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
			...
			?>
              <tr<?php echo $class;?>>
                <td width="34"><label>
                    <input type="checkbox" name="checkbox<?php echo $newsitem['News']['id']; ?>" id="checkbox" />
                </label></td>
                <td><?php echo $newsitem['News']['title']; ?></td>
                <td><?php echo $newsitem['News']['tags']; ?></td>
                <td><?php if ($newsitem['News']['active']==0) {echo 'Não';} else {echo 'Sim';} ?></td>                
                <td><?php echo date( "d/m/Y H:m", strtotime( $newsitem['News']['created'] ) ); ?></td>
                <td><?php echo date( "d/m/Y H:m", strtotime( $newsitem['News']['modified'] ) ); ?></td>
                <td width="90">
					<?php echo $html->link( null, array( 'action'=>'edit', $newsitem['News']['id'] ), array( 'class'=>'edit_icon', 'title'=>'Editar' ) ); ?>
					<?php echo $html->link( null, array( 'action'=>'delete', $newsitem['News']['id'] ), array( 'class'=>'delete_icon', 'title'=>'Apagar' ), sprintf( __( 'Tem certeza de que deseja apagar # %s?', true), $newsitem['News']['id'] ) ); ?>                
                </td>
              </tr>
              <?php endforeach; ?>
              <tr>
