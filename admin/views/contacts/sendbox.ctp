<div class="grid_16" id="content">
    <!--  TITLE START  --> 
    <div class="grid_9">
    	<h1 class="dashboard">Contatos Enviados</h1>
    </div>
    <div class="clear"></div>
    <!--  TITLE END  -->    
    <!-- #PORTLETS START -->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <div class="clear"></div>
    	...
    	<div class="portlet">
        <div class="portlet-header fixed"><img src="images/icons/user.gif" width="16" height="16" alt="Contatos" /><?php __( 'Contatos Enviados' );?></div>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
            <thead>
              <tr>
                ...
                <th width="100" scope="col"><?php echo $paginator->sort( 'Para' );?></th>
