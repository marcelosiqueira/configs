...
<div class="grid_16" id="content">
	<!-- CONTENT TITLE -->
	<div class="grid_9">
	  <h1 class="content_edit"><?php __( 'Editar Publicidade' );?></h1>
	</div>
	...
	<div class="grid_15" id="textcontent">
		...
		<?php
			...
			echo $form->input( 'file', array( 
					'div' => 'input',		
					'label' => array( 'text' => 'Imagem ou animação: ' ),
					'type' => 'file', 
					'error' => false,			
					'class' => 'largeInput wide' 
				) 
		...
		<a href="javascript:document.forms['HighlightEditForm'].submit();" class="button"><span>Salvar</span></a>
