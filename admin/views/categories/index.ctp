<div class="grid_16" id="content">
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Categorias de Produtos</h1>
    </div>
    <div class="clear"></div>
    <!--  TITLE END  -->    
    <!-- #PORTLETS START -->
	          ...
	          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
	            <thead>
	              <tr>
	                ...
	                <th width="102" scope="col"><?php echo $paginator->sort( 'Tags' );?></th>
				...
				?>
	              <tr<?php echo $class;?>>
	                <td width="34"><label>
	                    <input type="checkbox" name="checkbox<?php echo $category['Category']['id']; ?>" id="checkbox" />
	                </label></td>
	                <td><?php echo $category['Category']['name']; ?></td>
	                <td><?php echo $category['Category']['tags']; ?></td>
	                <td><?php echo date( "d/m/Y H:m", strtotime( $category['Category']['created'] ) ); ?></td>
	                <td><?php echo date( "d/m/Y H:m", strtotime( $category['Category']['modified'] ) ); ?></td>
	                <td width="90">
						<?php echo $html->link( null, array( 'action'=>'edit', $category['Category']['id'] ), array( 'class'=>'edit_icon', 'title'=>'Editar' ) ); ?>
						<?php echo $html->link( null, array( 'action'=>'delete', $category['Category']['id'] ), array( 'class'=>'delete_icon', 'title'=>'Apagar' ), sprintf( __( 'Tem certeza de que deseja apagar # %s?', true), $category['Category']['id'] ) ); ?>                
	                </td>
	              </tr>
	              <?php endforeach; ?>
	              <tr>
...
<!--  END #PORTLETS -->  
	...
	<div class="actions">
		<?php echo $html->link( __( '<span>Nova Categoria</span>', true ), array( 'action'=>'add' ), array( 'class'=>'button', 'title'=>'Nova Categoria' ),null,false ); ?>
	</div>
	</div>
</div>
