...
<div class="grid_16" id="content">
	<!-- CONTENT TITLE -->
	<div class="grid_9">
	  <h1 class="content_edit"><?php __( 'Editar Produto' );?></h1>
	</div>
	...
	<div class="grid_15" id="textcontent">
		...
		<a href="javascript:document.forms['ProductEditForm'].submit();" class="button"><span>Salvar</span></a>
