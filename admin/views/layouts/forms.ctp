...
<div id="menu">
	<ul class="group" id="menu_group_main">
		<li class="item first" id="one"><a href="dashboard.html" class="main"><span class="outer"><span class="inner dashboard">Dashboard</span></span></a></li>
...
<form id="edit" action="" method="post">
    	<label>Title</label>
        <input type="text" class="largeInput wide" />
        <!--WYSIWYG Editor is linked to the textarea with id: #wysiwyg-->
        <label>Edit Content</label>
        <textarea id="wysiwyg" class="largeInput wide" rows="7" cols="30"></textarea>
...
<div class="container_16" id="footer">
	Website Administration by <a href="http://www.webgurus.biz/">WebGurus
</a></div>
<!-- FOOTER END -->
</body>
</html>
