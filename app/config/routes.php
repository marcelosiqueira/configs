 ...
 */
	...
	//Delivery Routes
	Router::connect('/delivery/', array('controller' => 'delivery', 'action' => 'identificacao'));
/**
 ...
 */
	...
	// 
	//Router::connect('/lojas/sobre/:id-:slug', array('controller' => 'lojas', 'action' => 'sobre'), array( 'pass' => array('id', 'slug'), 'id' => '[0-9]+' ));
